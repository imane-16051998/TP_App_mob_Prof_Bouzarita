...
public class TeacherList extends AppCompatActivity implements  AdminAdapter.adminListener
,NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("liste des profs");
        navigationView.setNavigationItemSelectedListener(this);
        addTeacher.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TeacherList.this, addChefD.class);
    ...
    private void init() {
        rcv = findViewById(R.id.TeacherListRecyclerView);
        ...
        usersRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull @NotNull DataSnapshot snapshot, @Nullable @org.jetbrains.annotations.Nullable String previousChildName) {
                if (!snapshot.exists()) {
                    ...
                    Toast.makeText(TeacherList.this, "Nothin exist !", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public void onChefClick ( int position){
        Intent intent = new Intent(TeacherList.this, UserProfile.class);
    ...
    public boolean onNavigationItemSelected(@NonNull @NotNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.menu_block:
                Intent intnet2 = new Intent(TeacherList.this, MainActivity.class);
