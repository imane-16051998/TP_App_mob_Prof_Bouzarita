...
public class SpecList extends AppCompatActivity implements AdminAdapter.adminListener
        , NavigationView.OnNavigationItemSelectedListener{
    private FirebaseDatabase ROOT = FirebaseDatabase.getInstance();
    private DatabaseReference usersRef = ROOT.getReference("specs");
    private RecyclerView rcv;
    private ArrayList<specialty> UAL = new ArrayList<>();
    private String CurrentID,Department;
    private AdminAdapter mAdapter;
    private FloatingActionButton addSpec;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Liste des Spécialités");
        navigationView.setNavigationItemSelectedListener(this);
        mAdapter = new AdminAdapter(this, UAL,2, this);
        ...
        addSpec.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SpecList.this, addSpec.class);
    ...
    private void init() {
        ...
        addSpec = findViewById(R.id.addSpecialityButton);
        ...
        usersRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull @NotNull DataSnapshot snapshot, @Nullable @org.jetbrains.annotations.Nullable String previousChildName) {
                if (!snapshot.exists()) {
                    ...
                    Toast.makeText(SpecList.this, "Nothing exist !", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public boolean onNavigationItemSelected(@NonNull @NotNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.menu_amphi:
                Intent intent = new Intent(SpecList.this, UserProfile.class);
                intent.putExtra("CurrentID",CurrentID);
                intent.putExtra("FromItSelf","true");
                startActivity(intent);
                break ;
            case R.id.menu_block:
                Intent intnet2 = new Intent(SpecList.this, MainActivity.class);
